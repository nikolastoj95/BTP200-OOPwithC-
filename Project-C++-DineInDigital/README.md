...
```bash
~profname.proflastname/submit 200/prj/m? -due
```
...
```
~profname.proflastname/submit 200/prj/m1
```
...
Then, run the following command from your account (replace `profname.proflastname` with your professor’s Seneca userid):
```
~profname.proflastname/submit 200/prj/m2
```
and follow the instructions.
...
Then, run the following command from your account (replace `profname.proflastname` with your professor’s Seneca userid):
```
~profname.proflastname/submit 200/prj/m3
```
and follow the instructions.
...
Then, run the following command from your account (replace `profname.proflastname` with your professor’s Seneca userid):
```
~profname.proflastname/submit 200/prj/m4
```
and follow the instructions.
...
3. **Submit Your Work**:  
   ...
   ```bash
   ~profname.proflastname/submit 200/prj/m51
   ```  
...
3. **Submit Your Work**:  
   ...
   ```bash
   ~profname.proflastname/submit 200/prj/m52
   ```  
...
3. **Submit Your Work**:  
   ...
   ```bash
   ~profname.proflastname/submit 200/prj/m53
   ```  
...
3. **Submit Your Work**:  
   ...
   ```bash
   ~profname.proflastname/submit 200/prj/m54
   ```  
...
3. **Submit Your Work**:  
   ...
   ```bash
   ~profname.proflastname/submit 200/prj/m55
   ```  
...
3. **Submit Your Work**:  
   ...
   ```bash
   ~profname.proflastname/submit 200/prj/m56
   ```  
...
2. **Upload to Matrix:**  
   ...
   - Use the following command to submit your reflection:  
     ...
     ```bash
     ~profname.proflastname/submit 200/prj/mref
     ```  
